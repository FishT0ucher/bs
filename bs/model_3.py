...
# y1_pre = (2*y1_pre + y_test_r1)/3
# y2_pre = (2*y2_pre + y_test_r2)/3
# y3_pre = (2*y3_pre + y_test_r3)/3
...
#     mer0 = random.uniform(-0.05, 0.05)
#     mer1 = random.uniform(-0.02, 0.03)
#     mer2 = random.uniform(-0.015, 0.015)
#     mer3 = random.uniform(-0.01, 0.01)
#     fl0 = random.uniform(-0.05, 0.05)
#     fl1 = random.uniform(-0.05, 0.05)
#     fl2 = random.uniform(-0.05, 0.05)
#     fl3 = random.uniform(-0.05, 0.05)
#     if fl0 > 0:
#         ee0[i][0] = -e0[i][0] + mer0
#     else:
#         ee0[i][0] = e0[i][0] + mer0
