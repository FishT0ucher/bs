...
for batchnum in range(len(x_test_r1)):
    ...
    # x1[0] += torch.normal(torch.tensor(0.0), torch.tensor(0.8))
    x2 = x_test_r2[batchnum]
    # x2[0] += torch.normal(torch.tensor(0.0), torch.tensor(0.4))
    x3 = x_test_r3[batchnum]
    # x3[0] += torch.normal(torch.tensor(0.0), torch.tensor(0.3))
    x3 = torch.tensor([-1.0, -1.0])
    y1 = y_test_r1[batchnum]
    y2 = y_test_r2[batchnum]
    y3 = y_test_r3[batchnum]
    y0 = y_test_r0[batchnum]
...
plt.plot(e0, label='Normality', color='blue')
plt.plot(ee0, label='Malfunction', color='red', linestyle='--')
...
plt.plot(e1, label='Normality', color='blue')
plt.plot(ee1, label='Malfunction', color='red', linestyle='--')
...
plt.plot(e2, label='Normality', color='blue')
plt.plot(ee2, label='Malfunction', color='red', linestyle='--')
...
plt.plot(e3, label='Normality', color='blue')
plt.plot(ee3, label='Malfunction', color='red', linestyle='--')
